from instagram_web_api import Client, ClientError, ClientLoginError, ClientBadRequestError
import hashlib
import string
import random
import datetime
...
def getCookie(username, password):
    ...
    try:
        ...
        print('[-] Instagram detected bot bahaviour... \nPlease open your browser login to insta and run the bot again...')
        exit()
        return
    return client.settings['cookie']
